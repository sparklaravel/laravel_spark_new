...
$(window).on("load", function () {
    ...
    var barChart = new Chartist.Bar('#bar-chart', {
    ...
    },
        {
            ...
            axisY: {
                scaleMinSpace: 10, showGrid: true
            }

        });
    // Bar Chart Ends

    var barChart = new Chartist.Bar('#bar-chart2', {
        labels: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
        series: [
            [5, 4, 3, 7, 3, 7, 11]
        ]
    ...
    var distributedSeriesBarChart = new Chartist.Bar('#distributed-bar-chart', {
        labels: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
        series: [20000, 40000, 50000, 40000, 75000, 69000, 35000]
    },
        {
            showGrid: false,
    ...
    var distributedSeriesBarChart = new Chartist.Bar('#distributed-bar-chart2', {
        labels: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
        series: [20000, 40000, 50000, 40000, 75000, 69000, 35000]
    },
        {
